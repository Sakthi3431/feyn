...
export default function App() {
  ...
  },
  {
    ...
    return (<div style={{fontFamily: "ariel, sans-serif"}}>
        <nav className="container space-between flex px-5 py-10">
    ...
    <h2>Shop Now</h2>
        ...
        <div>
            <input 
            type="text" 
            className="bg-olive-200 rounded ml-5" 
            placeholder="Search"
            />
      ...
      <div className="grid grid-cols-4 gap-4" style={{
       ...
       <section style={
        ...
        <section className="p-2">
            ...
            <div className="bg-amber-100 flex gap-1 flex-wrap object-cover">

            <div className="card" onClick={() => setSelectedCategory("Home")}>
                <img className="rounded object-cover w-50" src="src/assets/4466.jpg" alt="" />
                <p>
                    For you
                </p>
            </div>
            <div className="card" onClick={() => setSelectedCategory("Fashion")}>
                <img className="rounded object-cover w-50" src="src/assets/4466.jpg" alt="" />
                <p>
                Fashion
                </p>
            </div >
            <div className="card" onClick={() => setSelectedCategory("Mobiles")}>
                <img className="rounded object-cover w-50" src="src/assets/4466.jpg" alt="" />
                <p>
                Mobiles
                </p>
            </div >
            <div className="card" onClick={() => setSelectedCategory("Beauty")}>
                <img className="rounded object-cover w-50" src="src/assets/4466.jpg" alt="" />
                <p>
                Beauty
                </p>
            </div>
            <div className="card" onClick={() => setSelectedCategory("Electronics")}>
                <img className="rounded object-cover w-50" src="src/assets/4466.jpg" alt="" />
                <p>
                Electronics
                </p>
            ...
            <div className="card" onClick={() => setSelectedCategory("Appliances")}>
                <img className="rounded object-cover w-50" src="src/assets/4466.jpg" alt="" />
                <p>
                Appliances
                </p>
            </div>
            <div className="card" onClick={() => setSelectedCategory("Toys")}>
                <img className="rounded object-cover w-50" src="src/assets/4466.jpg" alt="" />
                <p>
                Toys
                </p>
            </div>
            <div className="card" onClick={() => setSelectedCategory("Food")}>
                <img className="rounded object-cover w-50" src="src/assets/4466.jpg" alt="" />
                <p>
                Food
                </p>
            </div>
            <div className="card" onClick={() => setSelectedCategory("Auto")}>
                <img className="rounded object-cover w-50" src="src/assets/4466.jpg" alt="" />
                <p>
                Auto
                </p>
            </div>
            <div className="card" onClick={() => setSelectedCategory("Sports")}>
                <img className="rounded object-cover w-50" src="src/assets/4466.jpg" alt="" />
                <p>
                Sports
                </p>
            </div>
            <div className="card" onClick={() => setSelectedCategory("More")}>
                <img className="rounded object-cover w-50" src="src/assets/4466.jpg" alt="" />
                <p>
                More
                </p>
